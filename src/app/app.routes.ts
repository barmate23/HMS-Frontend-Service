...
export const routes: Routes = [
  { path: 'login', canActivate: [guestGuard], loadComponent: () => import('./auth/auth.component').then(m => m.AuthComponent) },
  {
    ...
    children: [
      ...
      { path: 'purchase/inward', loadComponent: () => import('./purchase/purchase.component').then(m => m.PurchaseComponent) },
      { path: 'purchase/bills', loadComponent: () => import('./purchase/purchase.component').then(m => m.PurchaseComponent) },
