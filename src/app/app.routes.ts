...
export const routes: Routes = [
  ...
  { path: 'activate-license', loadComponent: () => import('./auth/license-activation/license-activation.component').then(m => m.LicenseActivationComponent) },
  {
    ...
    children: [
      ...
      { path: 'billing/refunds', redirectTo: 'billing/folios', pathMatch: 'full' },
      { path: 'billing/inward', loadComponent: () => import('./billing/billing.component').then(m => m.BillingComponent) },
      { path: 'billing/bills', loadComponent: () => import('./billing/billing.component').then(m => m.BillingComponent) },
      ...
      { path: 'inventory/kitchen-stock', loadComponent: () => import('./inventory/inventory.component').then(m => m.InventoryComponent) },
      ...
      { path: 'purchase/dashboard', loadComponent: () => import('./purchase/purchase.component').then(m => m.PurchaseComponent) },
      { path: 'purchase/suppliers', loadComponent: () => import('./purchase/purchase.component').then(m => m.PurchaseComponent) },
      { path: 'purchase/orders', loadComponent: () => import('./purchase/purchase.component').then(m => m.PurchaseComponent) },
      { path: 'purchase/items', loadComponent: () => import('./purchase/purchase.component').then(m => m.PurchaseComponent) },
      ...
      { path: 'pos/ingredient-master', loadComponent: () => import('./pos/pos.component').then(m => m.PosComponent) },
      { path: 'pos/recipes', loadComponent: () => import('./pos/pos.component').then(m => m.PosComponent) },
      { path: 'pos/kds', loadComponent: () => import('./pos/kds/kds.component').then(m => m.KdsComponent) },
